import { Database, ProductBundleItem, ProductItem, getMatchingBundles } from "./model";
...
test('When product bundle contain more than requested product getMatchingBundles should return empty result', () => {
  ...
  const db: Database = {
    ...testDb,
    productBundles: [
      createTestProductBundle({ id: '#bundle1', name: 'Test_product_bundle', products: [...requestedProducts, '#prod2']}),
    ],
  };
